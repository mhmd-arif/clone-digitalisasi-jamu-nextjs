          ...
          <div className="flex flex-col gap-6 h-2/3">
            ...
            <div>
              ...
              <p className="text-earth-200 flex flex-col gap-2 text-base">
                Gendola (Indonesia), Lembayung (Minangkabau), Gondola (Sunda),
                Genjerot, Gedrek, Uci-uci (Jawa), Kandula (Madura), Gendola
                (Bali), Tatabuwe (Sulawesi Utara), Poiloo (Gorontalo), Rinutu
                (Ulias), Duyu numuno (Buol), Kandola (Timor)
              </p>
            </div>
            <div>
              <h3 className="text-earth-500 font-serif tracking-widest uppercase mb-1">
            ...
            <div>
              ...
              <p className="text-earth-200 flex flex-col gap-2 text-base">
                Daun digunakan untuk mengobati borok, bisul, susah buang air
                besar; getah daun untuk selesma; getah buah berwarna keunguan
                digunakan untuk radang selaput mata; akar digunakan untuk diare
              </p>
            </div>
          </div>
        </div>
