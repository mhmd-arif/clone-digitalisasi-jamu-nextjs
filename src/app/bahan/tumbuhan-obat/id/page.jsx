                ...
                <div className="w-3/5 flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-6 h-2/3">
                        ...
                        <div>
                            ...
                            <p className="text-earth-200 flex flex-col gap-2 text-base italic">
                                Basella rubra L., B. cordifolia Lamk., B. lucida
                                L.
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="text-earth-200 flex flex-col gap-2 text-base">
                                Gendola (Indonesia), Lembayung (Minangkabau),
                                Gondola (Sunda), Genjerot, Gedrek, Uci-uci
                                (Jawa), Kandula (Madura), Gendola (Bali),
                                Tatabuwe (Sulawesi Utara), Poiloo (Gorontalo),
                                Rinutu (Ulias), Duyu numuno (Buol), Kandola
                                (Timor)
                            </p>
                        </div>
                        <div>
                            ...
                            <p className="text-earth-200 flex flex-col gap-2 text-base">
                                Berupa tumbuhan berhabitus terna, batang lunak,
                                bulat, berwarna merah atau hijau, merambat
                                sampai 10 m; helaian daun tunggal, bentuk daun
                                elip sampai membulat, tangkai daun 0,2-1,8 cm,
                                panjang 1,3-8 cm, lebar 1-6,8 cm, pangkal daun
                                tumpul sampai menjantung, tepi rata, ujung
                                tumpul, pertulangan daun menyirip, licin dan
                                agak tebal, warna helaian daun hijau sampai
                                hijau kemerahan; bunga majemuk bulir, panjang
                                ibu tangkai bunga 3-20 cm, daun penumpu
                                memanjang, perhiasan bunga putih sampai
                                kemerahan-keunguan, bentuk bulat telur sampai
                                bulat telur memanjang, tangkai sari putih,
                                kepala putik kuning, buah Ketika masak berwarna
                                merah sampai kehitaman, diameter buah diameter
                        ...
                        <div>
                            ...
                            <p className="text-earth-200 flex flex-col gap-2 text-base">
                                Daun digunakan untuk mengobati borok, bisul,
                                susah buang air besar; getah daun untuk selesma;
                                getah buah berwarna keunguan digunakan untuk
                                radang selaput mata; akar digunakan untuk diare
                            </p>
                        </div>
                    </div>
                </div>
